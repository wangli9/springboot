...
(function(){
    ...
    function insertUpload(){
        ...
        for(var key in uploadVideoList) {
            ...
            videoObjs.push({
                url: uploadDir + file.url + "?fileNm=" + file.url + ".mp4",
                width:width,
                height:height,
                align:align
            });
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                //swf: 'http://10.238.1.247/kc/base/assets/components/uedit/third-party/webuploader/Uploader.swf',
                server: actionUrl,
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.STATUS == '0000' && json.RSP.ATTACH.fileId) {
                        uploadVideoList.push({
                            'url': json.RSP.ATTACH.fileId,
                            // 'type': json.type,
